...
getItem[1].innerHTML = hoodieBrand;
...
discountButtons[3].innerHTML = unicornButton;
...
discountButtons[4].innerHTML = fritoButton;
...
let pugBrand = 'Any Dog Breeder';
let pugItem = 'Baby Puggy';
let pugPrice = 'Priceless';
let pugButton = 'No Discounts.This cutie is worth every penny!';
getBrand[5].innerHTML = pugBrand;
getItem[5].innerHTML = pugItem;
getPrice[5].innerHTML = pugPrice;
discountButtons[5].innerHTML = pugButton;

//Final Boss 
//Create your own product for the last three sections.
const itemImg = document.getElementsByTagName('img');
let customBrand = "Samantha's Own";
let customItem = 'Existential Dread';
let customPrice = 'Your sanity and peace of mind';
let customButton = '75% off if you already have anxiety';
itemImg[10].src = 'https://i.imgur.com/IYC8eQe.jpg';
getBrand[6].innerHTML = customBrand;
getItem[6].innerHTML = customItem;
getPrice[6].innerHTML = customPrice;
discountButtons[6].innerHTML = customButton;